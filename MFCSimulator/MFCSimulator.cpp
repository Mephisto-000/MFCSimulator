...
// MFCSimulator.cpp: 定義應用程式的類別表現方式。
//
...
BEGIN_MESSAGE_MAP(CMFCSimulatorApp, CWinApp)
...
CMFCSimulatorApp::CMFCSimulatorApp()
{
	// 支援重新啟動管理員
...
// 唯一一個 CMFCSimulatorApp 物件

CMFCSimulatorApp theApp;


// CMFCSimulatorApp 初始化

BOOL CMFCSimulatorApp::InitInstance()
{
